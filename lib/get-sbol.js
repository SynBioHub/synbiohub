...
function getModuleDefinition(prefix, uri, stores, callback) {

    async.eachSeries(stores, (store, next) => {

        store.getModuleDefinitionSBOL(prefix, uri, (err, sbol, object) => {
...
function getComponentDefinition(prefix, uri, stores, callback) {
    ...
    async.eachSeries(stores, (store, next) => {
        ...
        store.getComponentDefinitionSBOL(prefix, uri, (err, sbol, object) => {
...
function getSequence(prefix, uri, stores, callback) {
...
function getModel(prefix, uri, stores, callback) {
...
function getGenericTopLevel(prefix, uri, stores, callback) {
...
function getModuleDefinitionMetadata(prefix, uri, stores, callback) {
