...
function summarizeActivity(activity,req,sbol,remote,graphUri) {
    ...
    var summary = {
        usages: summarizeUsages(activity),
        associations: summarizeAssociations(activity)
    }
    
    return Object.assign(summary,summarizeGenericTopLevel(activity,req,sbol,remote,graphUri))
}
