...
module.exports = function(req, res) {
	...
	locals.share = share
        ...
        locals.attachmentType = attachment.format
        ...
        locals.attachmentIsImage = attachment.format.toString().indexOf("png") >= 0 || attachment.format.toString() == "http://edamontology.org/format_3603" 
