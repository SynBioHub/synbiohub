...
module.exports = function(req, res) {
    ...
    getComponentDefinition(uri, graphUris).then((result) => {
        ...
        return Promise.all(otherComponents.map((otherComponent) => {
            ...
            return getComponentDefinitionMetadata(otherComponent, graphUris).then((res) => {
        ...
        if (meta.mutableDescription != '') {
            meta.mutableescription = wiky.process(meta.mutableDescription, {})
        }
        ...
        locals.annotations = locals.annotations.filter(function(annotation) {
            return (!annotation.name.toString().startsWith('created')) && (!annotation.name.toString().startsWith('modified')) && (!annotation.name.toString().startsWith('creator')) && (!annotation.name.toString().startsWith('source')) && (!annotation.name.toString().startsWith('igem#description')) && (!annotation.name.toString().startsWith('igem#discontinued')) && (!annotation.name.toString().startsWith('igem#dominant')) && (!annotation.name.toString().startsWith('igem#favorite')) && (!annotation.name.toString().startsWith('igem#discontinued')) && (!annotation.name.toString().startsWith('igem#group_u_list')) && (!annotation.name.toString().startsWith('igem#m_user_id')) && (!annotation.name.toString().startsWith('igem#notes')) && (!annotation.name.toString().startsWith('igem#owner_id')) && (!annotation.name.toString().startsWith('igem#owning_group_id')) && (!annotation.name.toString().startsWith('igem#rating')) && (!annotation.name.toString().startsWith('igem#replacedBy')) && (!annotation.name.toString().startsWith('synbiohub#'))
        })
