...
module.exports = function(req, res) {
	...
	if(componentDefinition.wasDerivedFrom.toString().indexOf('http://parts.igem.org/') === 0) {
		...
		new Promise((resolve, reject) => {
		    ...
		    request.get(componentDefinition.wasDerivedFrom.toString() + '?action=raw', function(err, res, body) {
			...
			if (meta.iGemMainPage != '') {
			    meta.iGemMainPage = wiky.process(meta.iGemMainPage.toString(), {})
			    meta.iGemMainPage = meta.iGemMainPage.replace('<br/>', '')
			}
		...
		new Promise((resolve, reject) => {
		    ...
		    request.get(componentDefinition.wasDerivedFrom.toString() + ':Design?action=raw', function(err, res, body) {
			...
			if (meta.iGemDesign != '') {
			    meta.iGemDesign = wiky.process(meta.iGemDesign.toString(), {})
			    meta.iGemDesign = meta.iGemDesign.replace('<br/>', '')
			}
		...
		new Promise((resolve, reject) => {
		    ...
		    request.get(componentDefinition.wasDerivedFrom.toString() + ':Experience?action=raw', function(err, res, body) {
			...
			if (meta.iGemExperience != '') {
			    meta.iGemExperience = wiky.process(meta.iGemExperience.toString(), {})
			    meta.iGemExperience = meta.iGemExperience.replace('<br/>', '')
			}
