...
module.exports = function(req, res) {
    ...
    fetchSBOLObjectRecursive('ComponentDefinition', uri, graphUri).then((result) => {
        ...
        if(req.params.userId) {
            ...
            locals.makePublic = '/user/' + encodeURIComponent(req.params.userId) + '/' + designId + '/makeTopLevelPublic'
            ...
            locals.copyTopLevelFromRemote = '/public/' + designId + '/copyTopLevelFromRemote'
	...
	locals.defaultBenchlingInstance = config.get("defaultBenchlingInstance")
	locals.defaultICEInstance = config.get("defaultICEInstance")
        ...
        if (isDNA) {
            locals.meta.displayList = getDisplayList(componentDefinition, config)
        }
