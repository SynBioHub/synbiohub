...
function submitPost(req, res, submissionData) {
	...
	function retrieveCollectionMetaData(next) {
	    ...
	    console.log('retrieving ' + uri)
            ...
            getCollectionMetaData(uri, graphUris, function(err, _metaData, _storeUrl) {
	...
	function convertSBOL(next) {
        ...
        function saveSubmission(next) {
            ...
            collection.addStringAnnotation('http://purl.org/dc/terms/creator', req.user.name);
