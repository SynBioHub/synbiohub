...
function advancedSearchPost(req, res) {
    ...
    getUriList(null).then((lists) => {
        ...
        return search(null, criteria, req.query.offset, limit).then((searchRes) => {
...
function getUriList(graphUri) {
    ...
    return Promise.all([
	    ...
	    sparql.queryJson(resultsQuery, graphUri).then((resultList) => {
            ...
            resultList.sort(sortByNames)

            return Promise.resolve({ resultList: resultList })
	    }),
