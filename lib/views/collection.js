...
module.exports = function (req, res) {
	...
	if (metaData.wasDerivedFrom) {
	    wasDerivedFroms = [ { uri: metaData.wasDerivedFrom,
				  url: metaData.wasDerivedFrom
				} ]
	}
	var wasGeneratedBys = []
	if (metaData.wasGeneratedBy) {
	    wasGeneratedBys = [ { uri: metaData.wasGeneratedBy || '',
        ...
        locals.meta = {
            ...
            wasDerivedFroms: wasDerivedFroms,
            wasGeneratedBy: { uri: metaData.wasGeneratedBy || '',
			      url: uriToUrl(metaData.wasGeneratedBy,req)
			    },
            wasGeneratedBys: wasGeneratedBys,
