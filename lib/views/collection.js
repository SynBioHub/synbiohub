    ...
    getCollectionMetaData(uri, graphUris).then((result) => {
        ...
        return Promise.all([
            ...
            sparql.queryJson(getAttachmentsQuery, graphUri).then((results) => {
                ...
                getAttachmentsFromList.getAttachmentsFromList(graphUris, attachmentList).then((results) => { 
	    ...
	    mutableProvenanceSource: metaData.mutableProvenanceSource || '',
	    mutableProvenance: metaData.mutableProvenance || '',
