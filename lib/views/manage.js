    ...
    stack.getPrefixes((err, prefixes) => {
        ...
        async.series([
            ...
            function retrievePublicSubmissions(next) {
                ...
                search(stack.getDefaultStore(), prefixes, 'Collection', criteria, undefined, undefined, (err, count, results) => {
            ...
            function retrievePrivateSubmissions(next) {
                ...
                search(req.userStore, prefixes, 'Collection',  criteria, undefined, undefined, (err, count, results) => {
