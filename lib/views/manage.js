    ...
    stack.getPrefixes((err, prefixes) => {
        ...
        async.series([
            ...
            function retrievePublicSubmissions(next) {
                ...
                search(stack, prefixes, 'ComponentDefinition', criteria, undefined, undefined, (err, count, results) => {
            ...
            function retrievePrivateSubmissions(next) {
                ...
                search(req.userStore, prefixes, 'ComponentDefinition',  criteria, undefined, undefined, (err, count, results) => {

                    locals.privateSubmissions = results.map((result) => {
