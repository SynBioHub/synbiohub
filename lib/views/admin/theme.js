...
module.exports = function (req, res) {
  if (req.method === 'POST') {
    console.log('HERE!!!!')
    console.log(req.body.showModuleInteractions)
    console.log(req.body.removePublicEnabled)
    console.log(req.body.requireLogin)
    ...
    if (req.body.requireLogin &&
      ...
      config.set('requireLogin', true) // default state
    }
