...
module.exports = function (req, res) {
  if (req.method === 'POST') {
    ...
    if (req.body.suppressLogs &&
      (req.body.suppressLogs === 'on' || req.body.suppressLogs === 'true')) {
      config.set('suppressLogs', true)
    } else if (req.body.suppressLogs &&
      (req.body.suppressLogs === 'off' || req.body.suppressLogs === 'false')) {
      config.set('suppressLogs', false)
    } else if (req.body.suppressLogs === undefined) {
      config.set('suppressLogs', false)
    } else {
      config.set('suppressLogs', false) // default state
    }
...
function form (req, res) {
  ...
  var locals = {
    ...
    suppressLogs: config.get('suppressLogs'),
