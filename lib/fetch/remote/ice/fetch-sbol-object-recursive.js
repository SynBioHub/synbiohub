			...
			sa.addRole("http://identifiers.org/so/SO:0000110")
                    ...
                    iceSA.locations.forEach((iceLocation) => {
                        ...
                        if(iceLocation instanceof Range) {
                            ...
                            genericLocation.version = version
