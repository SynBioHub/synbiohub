...
var getTopLevel = require('../get-sbol').getTopLevel
...
module.exports = function(req, res) {
    ...
    getTopLevel(uri, [ req.user.graphUri ]).then((result) => {
    ...
    function makePublic() {
		    ...
		    rootCollectionIdentity: config.get('databasePrefix') + 'public/' + collectionId + '/' + collectionId + '_collection/' + req.params.version,
                    newRootCollectionDisplayId: newRootCollectionDisplayId || '',
		    newRootCollectionVersion: req.params.version || '',
                    ownedByURI: '',
                    creatorName: '',
                    citationPubmedIDs: [],
