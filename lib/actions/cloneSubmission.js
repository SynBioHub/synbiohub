...
function clonePost(req, res, submissionData) {
    ...
    getCollection(uri, [ req.user.graphUri ]).then((result) => {
        ...
        var newUri = config.get('databasePrefix') + 'user/' + encodeURIComponent(req.user.email) + '/' + submissionData.id + '/' + submissionData.id + '_collection' + '/' + submissionData.version
    ...
    function doClone() {
        ...
        return new Promise((resolve, reject) => {
            ...
            console.log('saving...');
	    var newUri = config.get('databasePrefix') + 'user/' + encodeURIComponent(req.user.email) + '/' + submissionData.id + '/' + req.params.displayId + '/' + submissionData.version
