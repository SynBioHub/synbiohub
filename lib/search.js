...
function search(storeName, criteria, offset, limit, callback) {
    ...
    async.series([
        ...
        function performCount(next) {
            ...
            sparql.queryJson(countQuery, storeName, (err, result) => {
        ...
        function performSearch(next) {
            ...
            sparql.queryJson(searchQuery, storeName, (err, results) => {
