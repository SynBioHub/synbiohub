...
function App () {
  ...
  app.get('/public/:collectionId/:displayId/:version/addToCollection', requireAdmin, views.addToCollection)
  app.post('/public/:collectionId/:displayId/:version/addToCollection', requireAdmin, views.addToCollection)
