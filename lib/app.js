...
var actions = {
    addToCollection: require('./actions/addToCollection'),
    ...
    copyTopLevelFromRemote: require('./actions/copyTopLevelFromRemote'),
    ...
    admin: {
        uploadLogo: require('./actions/admin/uploadLogo'),
        updateUser: require('./actions/admin/updateUser'),
        deleteUser: require('./actions/admin/deleteUser'),
        updateInstanceName: require('./actions/admin/updateInstanceName'),
    }
}
...
function App() {
    ...
    app.post('/remoteLogin', forceNoHTML, views.login); /// DEPRECATED, use /login
    ...
    app.post('/remoteSubmit/', forceNoHTML, /*requireUser,*/ views.submit); /// DEPRECATED, use /submit
    ...
    app.post('/admin/uploadLogo', requireAdmin, uploadToMemory.single('file'), actions.admin.uploadLogo);
    ...
    app.post('/admin/updateInstanceName', requireAdmin, bodyParser.urlencoded({ extended: true }), actions.admin.updateInstanceName);
    ...
    app.post('/public/:collectionId/:displayId/:version/createSnapshot', actions.createSnapshot);
    ...
    app.get('/public/:collectionId/:displayId/:version/copyTopLevelFromRemote', requireUser, actions.copyTopLevelFromRemote);
    app.post('/public/:collectionId/:displayId/:version/copyTopLevelFromRemote', requireUser, uploadToMemory.single('file'), actions.copyTopLevelFromRemote);
    ...
    app.get('/user/:userId/:collectionId/:displayId/:version/addToCollection', requireUser, actions.addToCollection);
    app.post('/user/:userId/:collectionId/:displayId/:version/addToCollection', requireUser, uploadToMemory.single('file'), actions.addToCollection);
