...
const actions = {
  ...
  updateShare: require('./actions/updateShare'),
  admin: {
...
function App () {
  ...
  // Attach secondary users
  app.use(function (req, res, next) {
    if ((req.session.users === undefined || req.session.users.length === 0) && req.user) {
      req.session.users = [ req.user.id ]
    }
  ...
  app.get('/public/:collectionId/:displayId/:version/createShareLink', requireUser, views.createShareLink)
  app.post('/public/:collectionId/:displayId/:version/createShareLink', requireUser, views.createShareLink)
  ...
  app.get('/public/:collectionId/:displayId/:version/displayShareLink', requireUser, views.displayShareLink)
  app.post('/public/:collectionId/:displayId/:version/displayShareLink', requireUser, views.displayShareLink)
  ...
  app.get('/public/:collectionId/:displayId/:version/createShare', requireUser, views.createShare)
  app.post('/public/:collectionId/:displayId/:version/createShare', requireUser, views.createShare)

  app.get('/user/:userId/:collectionId/:displayId/:version/sharing', requireUser, views.sharing)
  app.get('/public/:collectionId/:displayId/:version/sharing', requireUser, views.sharing)

  app.post('/user/:userId/:collectionId/:displayId/:version/updateShare', requireUser, actions.updateShare)
  app.post('/public/:collectionId/:displayId/:version/updateShare', requireUser, actions.updateShare)
  ...
  async function authorize (req, res, next) {
    ...
    let users = req.session.users || [req.session.user]
