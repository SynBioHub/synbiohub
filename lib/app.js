...
function App() {
    ...
    app.post('/remoteLogin', views.login); /// DEPRECATED, use /login
    ...
    app.post('/remoteSubmit/', /*requireUser,*/ views.submit); /// DEPRECATED, use /submit
    ...
    app.get('/remoteSearch/:query?', views.search); /// DEPRECATED, use /search
