...
function App () {
  ...
  app.get('/public/:collectionId/:displayId/:version/:filename.xml', api.sbol) // deprecated
  app.get('/public/:collectionId/:displayId/:version/:filename.omex', api.omex) // deprecated
  app.get('/public/:collectionId/:displayId/:version/:filename.json', api.summary) // deprecated
  app.get('/public/:collectionId/:displayId/:version/:filename.fasta', api.fasta) // deprecated
  app.get('/public/:collectionId/:displayId/:version/:filename.gb', api.genBank) // deprecated
  app.get('/public/:collectionId/:displayId/:version/:filename.gff', api.gff3) // deprecated
  ...
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.xml', api.sbol) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.omex', api.omex) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.json', api.summary) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.fasta', api.fasta) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.gb', api.genBank) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:filename.gff', api.gff3) // deprecated
  ...
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.xml', api.sbol) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.omex', api.omex) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.json', api.summary) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.fasta', api.fasta) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.gb', api.genBank) // deprecated
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/:filename.gff', api.gff3) // deprecated
