...
var views = {
    ...
    makePublic: require('./views/makePublic')
}
...
function App() {
	...
	app.get('/api/sbol/:designid', api.sbol);

	app.get('/entry/:designURI/makePublic', views.makePublic);

	app.get('/entry/:prefix/:designid([^\\.]+)', views.entry);
	app.get('/entry/:prefix/:designid.xml', api.sbol);
	app.get('/entry/:prefix/:designid.json', api.summary);
	app.get('/entry/:prefix/:designid.fasta', api.fasta);

	app.get('/entry/:designURI([^\\.]+)', views.entry);
	app.get('/entry/:designURI.xml', api.sbol);
	app.get('/entry/:designURI.json', api.summary);
	app.get('/entry/:designURI.fasta', api.fasta);
