...
function App() {
	...
	app.get('/public/:collectionId/:displayId/:version/integrate', requireUser, views.dataIntegration);
	app.post('/public/:collectionId/:displayId/:version/integrate',
             requireUser, views.dataIntegration);
	...
	app.get('/user/:userId([^/]+)', views.profile)
	...
	app.get('/user/:userId/:collectionId/:displayId/:version/integrate', views.dataIntegration);
