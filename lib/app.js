...
function App () {
  ...
  app.post('/call', requirePublicLogin, actions.callPlugin)
  ...
  app.get('/admin/plugins', requirePublicLogin, views.admin.plugins)
  ...
  app.get('/admin/registries', requirePublicLogin, views.admin.registries)
  ...
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/sbol', requirePublicLogin, api.sbol)
