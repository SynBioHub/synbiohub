...
function App() {
    ...
    app.get('/public/:collectionId/:displayId/:version/makePublic', requireUser, actions.makePublic);
    app.post('/public/:collectionId/:displayId/:version/makePublic', requireUser, uploadToMemory.single('file'), actions.makePublic);

    app.get('/public/:collectionId/:displayId/:version/makeTopLevelPublic', requireUser, actions.makeTopLevelPublic);
    app.post('/public/:collectionId/:displayId/:version/makeTopLevelPublic', requireUser, uploadToMemory.single('file'), actions.makeTopLevelPublic);
