...
function postIceJson(remoteConfig, path, sbol) {
...
function createSequence(remoteConfig, sbol) {
    ...
    return postIceJson(remoteConfig, '/rest/file/sequence/', sbol)
